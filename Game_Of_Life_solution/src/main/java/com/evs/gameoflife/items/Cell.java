...
public class Cell {
  ...
  public void age() {
    if ( health == Health.ALIVE && !this.neighborhood.isWellPopulated()) nextHealth = Health.DEAD;
    else if ( health == Health.DEAD && this.neighborhood.isMatable()) nextHealth = Health.ALIVE;
  }
